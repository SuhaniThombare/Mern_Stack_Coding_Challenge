...
export default function TransactionDashboard() {
  ...
  const [statistics, setStatistics] = useState<Statistics>({ totalSalesAmount: 0, totalSold: 0, totalNotSold: 0 });
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">${statistics.totalSalesAmount.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Number of items in each price range for {month}</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Distribution of items by category for {month}</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
